    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that you have successfully completed the Astronomy 1 course with approval from a Physix instructor.")
            ...
            HStack(spacing: 20.0) {
                ...
                VStack(alignment: .leading, spacing: 8.0) {
                    Text("Astronomy 1").fontWeight(.bold)
