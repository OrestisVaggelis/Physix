...
let sectionData = [
    Section(title: "Relativistic mechanics", text: "18 Sections", logo: "phys9", image: Image(uiImage: #imageLiteral(resourceName: "Background1")), color: Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1))),
    Section(title: "Quantum mechanics", text: "20 Sections", logo: "phys8", image: Image(uiImage: #imageLiteral(resourceName: "Card6")), color: Color(#colorLiteral(red: 0.2588235438, green: 0.7568627596, blue: 0.9686274529, alpha: 1))),
    Section(title: "Cosmology - Astrophysics", text: "21 Sections", logo: "phys7", image: Image(uiImage: #imageLiteral(resourceName: "Card2")), color: Color(#colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1)))
]
        ...
        HStack(spacing: 30) {
            HStack(spacing: 12.0) {
                ...
                VStack(alignment: .leading, spacing: 4.0) {
                    ...
                    Text("Watched 10 minutes today").modifier(FontModifer(style: .caption))
                }
